...
const deletingBrandId = ref(null)
...
const isEditing = computed(() => {
    return editingBrand.value !== null
})
...
async function toggleBrandStatus(brand) {
    ...
    const confirmed = window.confirm(
        `Bạn có chắc muốn ${actionText} thương hiệu "${brand.name}" không?`,
    )
    ...
    try {
        ...
        successMessage.value =
            response.data?.message ??
            `Đã ${actionText} thương hiệu.`
    } catch (error) {
        errorMessage.value =
            error.response?.data?.message ??
            'Không thể cập nhật trạng thái thương hiệu.'
    }
}
        ...
        <div class="filter-panel">
            <div class="filter-field search-field">
                ...
                <input
                    ...
                    type="search"
                    placeholder="Tên hoặc slug thương hiệu"
                >
            </div>
